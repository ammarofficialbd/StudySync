...
import img from './../../assets/img/06-CEN6rti-.jpg'
import avatar1 from './../../assets/img/11-CBmAvHqK.jpg'
import vdo from './../../assets/img/12-WDjzCWMj.jpg'
import Background from '../../assets/img/image2.jpg'



function Banner() {
  return (
<section className="pt-3 pt-lg-5" style={{backgroundImage: `url(${Background})`, backgroundAttachment: 'fixed', opacity: ''}}>
    
    <div className="container">
        <div className="row g-4 g-lg-5">
            <div className="col-lg-6 position-relative mb-4 mb-md-0">
                <h1 className="mb-4 mt-md-5 display-5">  A Hub <span className="position-relative z-index-9">
                for Collaborative Education  <span
                            className="position-absolute top-50 start-50 translate-middle z-index-n1 d-none d-md-block mt-4"><svg
                                width="390.5px" height="21.5px" viewBox="0 0 445.5 21.5">
                ...
                <p className="mb-4 text-white"> Connect, Collaborate, and Excel with Seamless Study Sessions and Resource Sharing. </p>
                <div className="hstack gap-4 flex-wrap align-items-center">
                    <button
                        className="btn btn-primary-soft mb-0 bg-primary text-white">Discover Now</button><a className="glightbox  d-block"
                        href="https://www.youtube.com/embed/tXHviS-4ygo" id="image-popup-desc">
                        <div className="avatar avatar-md z-index-1 position-relative me-2"><img
                                className="avatar-img rounded-circle" src={vdo} alt="avatar"/>
                            <div
                                className="btn btn-xs btn-round btn-white shadow-sm position-absolute top-50 start-50 translate-middle z-index-9 mb-0 flex-centered">
                                <svg className="svg-inline--fa fa-play" aria-hidden="true" focusable="false"
                        ...
                        <div className="align-middle d-inline-block">
                            <h6 className="fw-normal small mb-0 text-white ">&nbsp;Watch our story</h6>
                        </div>
                    </a></div>
            </div>
            <div className="col-lg-6 position-relative"><img src={img} className="rounded"/>
                <figure className="position-absolute end-0 bottom-0"><svg width="163px" height="163px"
                        viewBox="0 0 163 163">
                ...
                <div className="position-absolute top-0 end-0 z-index-1 mt-n4">
                    <div className="bg-blur border border-light rounded-3 text-center shadow-lg p-3"><svg
                            width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" role="img"
                            focusable="false" className="text-danger fs-3 my-2">
                            <path
                ...
                <div
                    className="vstack gap-5 align-items-center position-absolute top-0 start-0 d-none d-md-flex mt-4 ms-n3">
                    <img className="icon-lg shadow-lg border border-3 border-white rounded-circle"
                        src={avatar1} alt="avatar"/><img
