...
function Header() {
    ...
    return (
        <header className={`navbar-light header-sticky ${active ? 'header-sticky-on' : ''}`}>
            <nav className="navbar navbar-expand-xl">
                <div className="container">
                    <a aria-current="page" href="/"
                        className="router-link-active router-link-exact-active navbar-brand">
                        <img className="light-mode-item navbar-brand-item" src={logo}
                            alt="logo" />
                        <img className="dark-mode-item navbar-brand-item"
                            src={logo} alt="logo" /></a>
                    <button className={`navbar-toggler ms-auto ms-sm-0 p-0 p-sm-2  ${showMenu ? 'not-collapsed' : 'collapsed'}`} type="button"
                        aria-controls="navbar-collapse" aria-expanded="false" onClick={() => setShowMenu(!showMenu)}><span
                            className="navbar-toggler-animation py-1"><span></span><span></span><span></span></span><span
                                className="d-none d-sm-inline-block small ms-1">Menu</span></button>
                    <button className="navbar-toggler ms-sm-auto mx-3 me-md-0 p-0 p-sm-2 collapsed" type="button"
                        aria-controls="navbar-category-collapse" aria-expanded="false" onClick={() => setShowCat(!showCat)}><svg width="1em" height="1em"
                            viewBox="0 0 16 16" fill="currentColor" role="img" focusable="false" className="fa-fw">
                            <path
                        ...
                        </svg><span className="d-none d-sm-inline-block small">Category</span></button>
                   
                    <div id="navbar-category-collapse" className={`collapse navbar-collapse ${showCat ? 'show' : ''}`} is-nav="false">
                        <ul className="navbar-nav navbar-nav-scroll nav-pills-primary-soft text-center ms-auto p-2 p-xl-0">
                            <li className="nav-item"><NavLink aria-current="page" to="/all-Session"
                                className="router-link-active router-link-exact-active nav-link active"><svg width="1em"
                                ...
                                </svg> Session</NavLink></li>
                            <li className="nav-item"><a href="/" className="nav-link"><FaBlogger className="me-1"/> Blogs</a></li>
                            <li className="nav-item">
                                <a href="" className="nav-link"><svg width="1em"
                                height="1em" viewBox="0 0 16 16" fill="currentColor" role="img" focusable="false"
                                className="me-1">
                                <path
                            ...
                            {
                                    user ? '' : <> <li className="nav-item ms-3"> <NavLink to={'/login'} 
                                    className="nav-link">Log in</NavLink> 
                                    </li>
                                    <li className="nav-item ms-3"> <NavLink to={'/signup'}
                    ...
                    <ul className="nav flex-row align-items-center list-unstyled ms-xl-auto">
                        <li className="dropdown nav-item ms-0 ms-md-3"><a className="nav-notification btn btn-light p-0 mb-0"
                                ...
                                <div className="card bg-transparent">
                                    <div className="card-body p-0">
                                        ...
                                        <div className="card-body p-0">
                                            <ul className="list-group list-group-flush list-unstyled p-2">
                                                <li><a href="#"
                                                    ...
                                                    <p className="mb-0 small">Find the flexible ticket on flights around the
                                                        world. Start searching today</p><span>05 Feb 2024</span>
                                                </a></li>
                                                <li><a href="#"
                                                    className="list-group-item list-group-item-action rounded border-0 mb-1 p-3">
                                                    <h6 className="mb-2">Sunshine saving are here 🌞 save 30% or more on a
                                                        stay</h6>
                                        ...
                                        <div className="card-footer bg-transparent text-center border-top"><a href="#"
                                            className="btn btn-sm btn-link mb-0 p-0">See all incoming activity</a></div>
                                    </div>
                                </div>
                            </div>
                        </li>
                        {
                            user ?  
                            <li className="dropdown nav-item ms-3"><a className="avatar avatar-sm p-0" href="#" role="button"
                            data-bs-auto-close="outside" data-bs-display="static" data-bs-toggle="dropdown"
                            aria-expanded="false" onClick={() => setShow(!show)}><img className="avatar-img rounded-2" src={user?.photoURL || avatar }
                                alt="avatar" /></a>
                            <ul className={`dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3 ${show ? 'show' : ''}`}
                                ...
                                <li><NavLink to={'/dashboard'} className="dropdown-item"><svg width="1em" height="1em"
                                ...
                                </svg> My Dashboard </NavLink></li>
                                <li><a href="/booking_v/user/wishlist" className="dropdown-item"><svg width="1em" height="1em"
                                    viewBox="0 0 16 16" fill="currentColor" role="img" focusable="false"
                                    className="fa-fw me-2">
                                    <path
                                        d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15">
                                    </path>
                                </svg> My Wishlist </a></li>
                                <li><a href="/booking_v/user/settings" className="dropdown-item"><svg width="1em" height="1em"
                                    viewBox="0 0 16 16" fill="currentColor" role="img" focusable="false"
                                    className="fa-fw me-2">
                                    <path
                                ...
                                <li><a href="/booking_v/help/center" className="dropdown-item"><svg width="1em" height="1em"
                                    viewBox="0 0 16 16" fill="currentColor" role="img" focusable="false"
                                    className="fa-fw me-2">
                                ...
                                <li><div  className="dropdown-item bg-danger-soft-hover cursor-pointer" onClick={handleSignOut}><svg width="1em"
                                ...
                                <li>
                                    <div
                                        className="nav-pills-primary-soft theme-icon-active d-flex justify-content-between align-items-center p-2 pb-0">
                                        <span>Mode:</span><button type="button"
                                            className="btn btn-link nav-link text-primary-hover mb-0 p-0 active"
                                            data-original-title="light"><svg width="1em" height="1em" viewBox="0 0 16 16"
                                            ...
                                            </svg></button><span data-v-app=""><span></span></span><button
                                                type="button" className="btn btn-link nav-link text-primary-hover mb-0 p-0"
                                                data-original-title="dark"><svg width="1em" height="1em" viewBox="0 0 16 16"
                                                    fill="currentColor" role="img" focusable="false">
                                                <path
                                                ...
                                                type="button" className="btn btn-link nav-link text-primary-hover mb-0 p-0"
                                                data-original-title="auto"><svg width="1em" height="1em" viewBox="0 0 16 16"
                                                    fill="currentColor" role="img" focusable="false">
                                                <path d="M8 15A7 7 0 1 0 8 1zm0 1A8 8 0 1 1 8 0a8 8 0 0 1 0 16"></path>
                                            </svg></button><span data-v-app=""><span></span></span>
                                    </div>
                                </li>
                            </ul>
                        </li> : <> 
