...
function CreateStudySession() {
  ...
  const handleFormSubmit = async e => {
    ...
    try {
      const sessionData = {
        sessionTitle, sessionDescription, tutor, registrationFee , registrationStartDate : selectedRegiStartDate, registrationEndDate: selectedRegiEndDate, classStartDate : selectedClassSatrtDate, classEndDate: selectedClassEndDate, sessionDuration, status
      }
                    ...
                    <div className="row g-4">
                      ...
                      <div className="col-12">
                        <fieldset className="" id="__BVID__548048___BV___">
                          ...
                          <div className=""><input className="form-control" name='title' type="text"
                      ...
                      <div className="col-12">
                        <fieldset className="" id="__BVID__698262___BV___">
                          ...
                          <div className=""><textarea id="__BVID__250729___BV_input__" className="form-control"
                            placeholder="Enter Description" rows="2" wrap="soft" name='desc'></textarea> </div>
                        </fieldset>
                      </div>
                    </div>
                  </div>
